...
As the submarine drops below the surface of the ocean,
    it automatically performs a sonar sweep of the nearby sea floor.On
        a small screen,
    ...
    199 200 208 210 200 207 240 269 260 263 This report indicates that,
    scanning outward from the submarine, the sonar sweep found depths of 199,
    200, 208, 210,
    and so on.
...
get carried into deeper water by an ocean current or a fish or something.
    ...
    199(N / A - no previous
measurement)200(increased)208(increased)210(increased)200(
